...
struct config4 : nnet::dense_config {
    ...
    static const unsigned n_zeros = 189;
    static const unsigned n_nonzeros = 4931;
...
struct config7 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 3948;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config10 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 3951;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config19 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 162;
    static const unsigned n_nonzeros = 3934;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config25 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 3945;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
