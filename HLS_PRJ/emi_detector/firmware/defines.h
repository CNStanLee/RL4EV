...
typedef ap_fixed<24,9> dense0_accum_t;
typedef ap_fixed<17,9> dense0_t;
typedef ap_fixed<9,2> dense0_weight_t;
typedef ap_fixed<16,1> dense0_bias_t;
...
typedef ap_fixed<24,10> chan_accum_t;
typedef ap_fixed<24,10> result_t;
typedef ap_fixed<9,2> chan_weight_t;
typedef ap_fixed<10,0> chan_bias_t;
