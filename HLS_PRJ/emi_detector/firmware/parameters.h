...
struct config3 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 2711;
...
struct relu_config4 : nnet::activ_config {
    ...
    static const unsigned table_size = 16777216;
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned reuse_factor = 1;
...
struct config6 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 4039;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config9 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 319;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef chan_accum_t accum_t;
    typedef chan_bias_t bias_t;
    typedef chan_weight_t weight_t;
