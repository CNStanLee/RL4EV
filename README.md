...
| 目录 | 内容 |
|---|---|
| [`Simulation/PV_MEV/`](Simulation/PV_MEV/) | 主 Simulink 模型（PV + 三相 PFC + 充电级）、8 种控制策略、注入试验台与运行脚本；文档见 [`docs/EMI_INJECTION_TEST_PLAN.md`](Simulation/PV_MEV/docs/EMI_INJECTION_TEST_PLAN.md) 与 [`docs/EMI_DETECTION_PHASES_2-4_PLAN.md`](Simulation/PV_MEV/docs/EMI_DETECTION_PHASES_2-4_PLAN.md) |
